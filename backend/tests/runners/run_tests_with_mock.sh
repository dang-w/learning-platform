...
cd .. && python -m pytest tests/api/ tests/services/ -v --no-header --showlocals
...
if [ $TEST_EXIT_CODE -eq 0 ]; then
    ...
    echo "Consider running specific tests with './runners/run_single_test.sh api/test_file.py' for more details."
fi
