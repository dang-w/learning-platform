...
import { SpacedRepetitionOnboarding } from '@/components/knowledge';
...
export default function KnowledgePage() {
  ...
  useEffect(() => {
    ...
    const checkOnboardingStatus = () => {
      if (typeof window !== 'undefined') {
        const onboardingCompleted = localStorage.getItem('spacedRepetitionOnboardingCompleted');
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Spaced Repetition Onboarding Modal */}
