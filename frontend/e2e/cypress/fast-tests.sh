...
rm -rf ./e2e/reports/*
rm -rf ./e2e/cypress/reports/*
rm -rf ./e2e/cypress/screenshots/*
rm -rf ./e2e/cypress/videos/*

# Create reports directory
mkdir -p ./e2e/cypress/reports/fast
...
REPORTER_CONFIG_PATH="./e2e/config/multi-reporter-config.json"
npx cypress-parallel -s cypress:headless -t $THREAD_COUNT -d ./e2e/cypress/e2e --specsDir ./e2e/cypress/e2e --reporter cypress-multi-reporters --reporter-options configFile=$REPORTER_CONFIG_PATH
