...
export class AnalyticsPage extends BasePage {
  ...
  /**
   * Check if the analytics page is loaded
   */
  isAnalyticsPageLoaded(): Cypress.Chainable<boolean> {
    return this.elementExists(this.selectors.analyticsContainer);
  }
  ...
  /**
   * Verify that overview chart is displayed
   */
  verifyOverviewChartVisible(): Cypress.Chainable<boolean> {
    return this.elementExists(this.selectors.overviewChart);
  }
